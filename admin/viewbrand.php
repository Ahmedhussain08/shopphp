...
<body>
    <div class="container mt-4 p-3">
        <div class="row">
            ...
            <a href="index.php?addbrand" class="btn btn-success my-4">ADD NEW</a>
                 ...
                 <table class="table border border-3 bg-dark text-white" border='1'>
                     ...
                     <?php
                     $i=1;
                         $row = mysqli_query($con,"select * from brand");
                         ...
                         if(isset($_GET['deleteid'])){
                             $del = $_GET['deleteid'];
                             $delete = mysqli_query($con,"DELETE FROM category WHERE bid ='$del'");
