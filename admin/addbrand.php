...
if(isset($_POST['btn'])){
    $name = $_POST['name'];
    $sql = mysqli_query($con,"INSERT INTO `brand` (`bname`) VALUES ( '$name')");
    if($sql){
...
<body>
      ...
      <h1 class="text-center">INSERT NEW BRAND</h1>
      <div class="row">
          <div class="col-11 mx-auto">
              ...
              <div class="form-group mt-4">
                  ...
                  <div class="form-group mt-4">
                      <label for="exampleInputEmail1 mb-1">Enter BRAND Name</label>
