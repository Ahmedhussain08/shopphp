...
if(isset($_POST['login'])){
    $email = $_POST['email'];
    $password = $_POST['pass'];
   $query = mysqli_query($con,"select * from phptab where email = '$email' and password = '$password'");
...
<div class="container mt-5 p-3">
        <h1 class="text-center text-white mt-3 fw-bold fs-1">LOG IN TO CONTINUE</h1>
      ...
      <div class="parentdiv mx-auto d-flex flex-row col-md-10 rounded mb-3" >
        ...
        <div class="me-2 input-div col-md-10 p-2">  <input name="email" class=" input form-control form-control-lg " type="email" placeholder="ENTER EMAIL">  </div>
      </div>
  ...
  if($error==true){
   echo '<div class="alert bg-danger col-md-10 mx-auto text-center text-white alert-danger alert-dismissible fade show" role="alert">
   ...
   <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
      ...
      <div class=" mx-auto d-flex flex-row col-md-11  rounded " >
        <button class=" mx-3 btn btn-danger p-2 text-bold fs-3 fw-bold" name="login" type="submit">LOG IN</button>
</div>
    <div id="buttons" class="  mt-5 mx-auto col-md-10 fs-2 fw-bold">
        ...
        <a class="text-danger col-md-4" href="signup.php">SIGN UP </a>
    </div>
